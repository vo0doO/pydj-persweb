...
# from project.apps.curiosity.models import Channel, Post, Tag
...
def img_1_downloader(img_1_href, post_slug):
    if img_1_href is not None:
        ...
        with open(f"{os.path.dirname(os.path.abspath(__file__))}/curiosity/static/curiosity/img/{post_slug}.png", 'wb') as zero:
