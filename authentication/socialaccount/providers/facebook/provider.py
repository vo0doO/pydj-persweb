...
from authentication.socialaccount.providers.base import (
    AuthAction,
    AuthProcess,
    ProviderAccount,
)
from authentication.socialaccount.providers.oauth2.provider import OAuth2Provider
from authentication.utils import import_callable
...
class FacebookProvider(OAuth2Provider):
    ...
    def get_login_url(self, request, **kwargs):
        ...
        if method == 'js_sdk':
            ...
            js = "authentication.facebook.login(%s, %s, %s)" % (next, action, process)
    ...
    def media_js(self, request):
        ...
        from authentication.socialaccount.models import SocialApp
