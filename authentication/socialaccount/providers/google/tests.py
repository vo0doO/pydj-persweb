...
from authentication.account import app_settings as account_settings
from authentication.account.adapter import get_adapter
from authentication.account.models import EmailAddress, EmailConfirmation
from authentication.account.signals import user_signed_up
from authentication.socialaccount.models import SocialAccount, SocialToken
from authentication.socialaccount.tests import OAuth2TestsMixin
from authentication.tests import MockedResponse, TestCase, patch
...
class GoogleTests(OAuth2TestsMixin, TestCase):
    ...
    def test_google_compelete_login_401(self):
        from authentication.socialaccount.providers.google.views import \
            GoogleOAuth2Adapter
        ...
        with patch(
                'authentication.socialaccount.providers.google.views'
