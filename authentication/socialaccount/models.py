...
import authentication.app_settings
from authentication.account.models import EmailAddress
from authentication.account.utils import get_next_redirect_url, setup_user_email
...
class SocialAccount(models.Model):
    user = models.ForeignKey(authentication.app_settings.USER_MODEL,
