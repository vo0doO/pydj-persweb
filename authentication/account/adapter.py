...
class DefaultAccountAdapter(object):
    ...
    def is_email_verified(self, request, email):
        ...
        beyond authentication scope, for example, by having accepted an
    ...
    def _get_login_attempts_cache_key(self, request, **credentials):
        ...
        return 'authentication/login_attempts@{site_id}:{login}'.format(
            site_id=site.pk,
            login=login_key)
    ...
    def authenticate(self, request, **credentials):
        ...
        from authentication.account.auth_backends import AuthenticationBackend
